...
public enum AIProvider: String, CaseIterable, Identifiable, Codable, Sendable {
    ...
    public var availableModels: [String] {
        ...
        case .localMLX:
            return ["gemma-3n-e2b-mlx", "gemma-3n-e4b-mlx", "qwen3.5-2b-mlx", "qwen3.5-0.8b-mlx", "phi-4-mini-mlx", "llama-3.2-1b-mlx", "llama-3.2-3b-mlx", "ministral-3b-mlx", "falcon3-3b-mlx", "granite-3.3-2b-mlx", "deepseek-r1-qwen-1.5b-mlx"]
        }
    }
}
