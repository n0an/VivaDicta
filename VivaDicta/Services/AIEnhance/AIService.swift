    ...
    public func updateDefaultModeIfNeeded(provider: TranscriptionModelProvider, modelName: String) {
        ...
        if defaultMode.transcriptionModel.isEmpty {
            ...
            let updatedMode = VivaMode(
                ...
                isChatEnabled: defaultMode.isChatEnabled,
                chatProvider: defaultMode.chatProvider,
                chatModel: defaultMode.chatModel,
                isImplicitCrossNoteSearchEnabled: defaultMode.isImplicitCrossNoteSearchEnabled,
                isImplicitWebSearchEnabled: defaultMode.isImplicitWebSearchEnabled,
