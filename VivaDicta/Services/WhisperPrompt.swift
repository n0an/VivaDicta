...
class WhisperPrompt {
    ...
    private let defaultLanguagePrompts: [String: String] = [
        ...
        "ar": "أريد أن أتابع اجتماعنا بالأمس حول المشروع. ناقشنا الجدول الزمني وتوزيع الميزانية. يرجى إعلامي إذا كنت تحتاج معلومات إضافية.",
        "fa": "می‌خواستم در مورد جلسه دیروز پروژه صحبت کنم. در مورد زمان‌بندی و تقسیم بودجه بحث کردیم. اگر اطلاعات بیشتری نیاز دارید لطفاً اطلاع دهید.",
        "he": "רציתי לדבר על הפגישה של אתמול לגבי הפרויקט. דיברנו על הלוח זמנים וחלוקת התקציב. אנא הודיעו לי אם אתם צריכים מידע נוסף.",
